package com.yasn.purchase.superfileview;
...
public class ExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void initConfig(Context context) {
        ...
        saveSpacePath = new File(Environment.getExternalStorageDirectory().getAbsolutePath(),"/001");
        localErrorSave = new File(saveSpacePath,new SimpleDateFormat("yyyy-MM-dd").format(new Date(System.currentTimeMillis()))+"error.txt");
